...
namespace VMS.Controllers
{
    public class DriverMasterController : Controller
    {
            ...
            if (userDetails != null)
            {
                ...
                if (user.Count() == 0)
                {
                    try
                    {
                        ...
                        //driverMaster.Id = id;
                        driverMaster.DriverName = driverName;
                        driverMaster.FatherName = fatherName;
                        driverMaster.DriverAddress1 = driverAddress1;
                        driverMaster.DriverAddress2 = driverAddress2;
                        driverMaster.DriverAddress3 = driverAddress3;
                        driverMaster.StateId = stateId;
                        driverMaster.DistrictId = districtId;
                        driverMaster.CityId = cityId;
                        driverMaster.PinCode = pinCode;
                        ...
                        driverMaster.BankIfsccode = bankIfscCode;
                        driverMaster.DrivingLicenceNo = drivingLicenceNo;
                        driverMaster.DrivingLicenceIssueAuth = drivingLicenceAuth;
                        ...
                        driverMaster.MobileNumber1 = mobileNo1;
                        driverMaster.MobileNumber2 = mobileNo2;
                        driverMaster.IsExistingReference = isExistingReference;
                        driverMaster.ReferenceName = referenceName;
                        driverMaster.ReferenceAddress1 = referenceAddress1;
                        driverMaster.ReferenceAddress2 = referenceAddress2;
                        driverMaster.ReferenceAddress3 = referenceAddress3;
                        driverMaster.ReferenceCity = referenceCity;
                        driverMaster.ReferencePin = referencePin;
                        driverMaster.ReferenceMobile = referenceMobile;
        ...
        public JsonResult deleteDriverMaster(string driverMasterID)
        {
            ...
            {
                model.TransactionMessage.Status = TransactionStatus.Error;
                model.TransactionMessage.Message = "Driver Master has not been deleted. Please try again.";
            }
            return Json(model);
        }
